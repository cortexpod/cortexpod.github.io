...
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Aperture ($\mathit{f}/N$)**     | Controls the size of the camera's aperture. Higher values ($\mathit{f}/16$) indicate a smaller aperture, while lower values ($\mathit{f}/1.4$) indicate a wider aperture. Affects exposure and depth of field. |
